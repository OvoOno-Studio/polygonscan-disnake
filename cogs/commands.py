...
class Commands(commands.Cog):
    ...
    async def getTrx(self, ctx: commands.Context, address: str, key=key, counter=0):    
        endpoint = f'https://api.polygonscan.com/api?module=account&action=txlist&address={str(address)}&startblock=0&endblock=99999999&page=1&offset=10&sort=desc&apikey={str(key)}'
